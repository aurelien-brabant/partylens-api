...
module.exports = {
	...
	hasPermissions: (currentPermissionBits, expectedPermissionBits) =>
	{
	...
	removePermissions: (currentPermissionBits, removedPermissionBits) =>
	{
	...
	addPermissions: (currentPermissionBits, addedPermissionBits) =>
	{
